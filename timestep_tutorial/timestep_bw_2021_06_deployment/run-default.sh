...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/control-${timestamp}.log -T "control" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,control" &
waitUntilJoined control 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/processor-${timestamp}.log -T "processor" -geometry 140x40+60+90 -e "mvn exec:java -P ExecJava,processor" &
waitUntilJoined processor 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/socket-${timestamp}.log -T "socket" -geometry 140x40+90+120 -e "mvn exec:java -P ExecJava,socket" &
