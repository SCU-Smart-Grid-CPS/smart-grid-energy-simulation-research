...
public class processorBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public processorBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // interaction pubsub
        procToCtrl.publish(getLRC());
        sockToProc.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           sockToProc.get_handle(),
    ...
    public procToCtrl create_procToCtrl() {
        procToCtrl interaction = new procToCtrl();
